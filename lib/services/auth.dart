...
class AuthService {
  ...
  Future registerWithEmailAndPassword(String email, String password, String name, String address, String wasteBin, String recBin, int userPin, int waste1, int waste2, int waste3) async
    {
      try {
        ...
        await DatabaseService(uid: user.uid).updateUserData(name, address, wasteBin, recBin, userPin, waste1, waste2, waste3);
